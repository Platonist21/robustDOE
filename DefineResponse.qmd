...
The first scenario is that all the differences of $T_{i,k}-\mu_k$ are just measurement variability, i.e., $T_{i,k}-\mu_k=\epsilon_{i,k}$. Under this model, $\hat{Y_i}=\frac{1}{K} \sum_{k}{(T_{i,k}-m_k)^2}$.
